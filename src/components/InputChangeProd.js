    ...
    return (
      <div>
        <input
          ...
          onChange={(e) =>
            this.setState({ nyNamn: e.target.value, disabled: false })
          }
          maxLength="20"
        />
        <input
          ...
          onChange={(e) =>
            this.setState({ nyPris: e.target.value, disabled: false })
          }
          min="0"
        />
        <input
          type="number"
          value={this.state.nyAntal}
          placeholder={this.props.produktAntal}
          onChange={(e) =>
            this.setState({ nyAntal: e.target.value, disabled: false })
          }
          min="0"
        />
        <button
